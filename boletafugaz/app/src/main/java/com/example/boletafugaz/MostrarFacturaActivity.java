...
public class MostrarFacturaActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MostrarFacturaActivity.this, HistorialFacturasActivity.class));
            }
        });
            ...
            case R.id.btnImprimir:
                if (bluetoothSocket != null) {
                    try {
                        ...
                        PrintHelper photoPrinter = new PrintHelper(MostrarFacturaActivity.this);
                            ...
                            try {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Toast.makeText(MostrarFacturaActivity.this, "Dispositivo Conectado", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        txtLabel.setText("");
                                        Toast.makeText(MostrarFacturaActivity.this, "No se pudo conectar el dispositivo", Toast.LENGTH_SHORT).show();
                                    }
                                });
